...
The closer Figure \ref{fig:Ch-Results-Diagonal-Sums} comes to a spike the more incoherent is the blending pattern. Thus, the incoherency, $\mu$, is measured as the ratio between squared absolute value of the summed main diagonal of $\mathbf{\Gamma \Gamma}^H$ and the sum of all squared absolute summed sub-diagonals;

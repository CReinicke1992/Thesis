...
After summing the sub-diagonal elements the length of the resulting complex number indicates if the elements superimposed constructively or destructively. The resulting number is squared in order to put it in terms of energy;

...
The sum of the elements along the $k^{th}$ sub-diagonal can be constructive or destructive depending on the phase variability. This allows to use absolute value of the sum as a incoherency measure for an individual sub-diagonal. The resulting value is squared in order to put it in terms of energy;

...
In general, these sub-diagonal elements, $\mathrm{e}^{-j \omega \Delta t_{kl}}$, are complex numbers with length 1 and variable phase. Hence, these elements are located on a unit circle in the complex number plane.

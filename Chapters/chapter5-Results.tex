...
\begin{figure}
	\centering
	\includegraphics[width = 0.6\textwidth]{Plots/2dvs3dfk/quality_line_plot_avg-2dfk}
	\caption{The plot of Figure \ref{fig:Ch-Results-QualityFactors} is reproduced with a 2D $f$-$k_x$ filter instead of a 3D $f$-$k_x$-$k_y$ filter. Note that the quality factors decreased significantly.}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{Plots/Feasibility/acquisition-set-up-syn}

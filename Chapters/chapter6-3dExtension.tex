...
The 3D $f$-$k_x$-$k_y$ filter removes incoherent energy in the crossline and inline direction. The 3D blended acquisition design suggested in this thesis blends sources within the same crossline. Hence, the question arouses whether an extension of the 2D $f$-$k_x$ filter to the inline direction provides significant deblending enhancements.

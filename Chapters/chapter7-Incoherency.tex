...
Although examples of spatial incoherency are shown in this chapter, it has to be noted that to blend shots in a spatially incoherent fashion is not very practical in 2D acquisition. However, in the chapter \ref{chap:MahdadMethod3d} it will be shown that for 3D blending spatial incoherency becomes feasible.

In practice, 2D blended acquisition does not allow to blend shots in a spatially incoherent fashion, because the source is moved by the vessel from one source position to the next.  

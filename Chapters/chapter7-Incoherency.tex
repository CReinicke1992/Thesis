...
In practice in 2D blending shots cannot be blended in a spatially incoherent fashion. This changes when blending is extended to 3D, within the crossline direction shots can be selected randomly and blended spatially incoherent. 

...
\nomenclature{$M(d,\omega)$}{(Monochromatic) absolute value of the sum along the $d^{th}$ sub-diagonal of the matrix product $\mathbf{\Gamma \Gamma}^H(\omega)$}
...
\nomenclature{$\mathbf{\Gamma}_{coh}$}{(Monochromatic) blending matrix with constant firing-time delays}
\nomenclature{$\mathbf{\Gamma}_{ran}$}{(Monochromatic) blending matrix with random firing-time delays}
\nomenclature{$\mu_{coh}$}{Incoherency of the blending matrix $\mathbf{\Gamma}_{coh}$}
\nomenclature{$\mu_{ran}$}{Incoherency of the blending matrix $\mathbf{\Gamma}_{ran}$}
...
\nomenclature{$\mathbf{\Gamma}_{eff}$}{Linear superposition of the blending matrices $\mathbf{\Gamma}_{coh}$ and $\mathbf{\Gamma}_{ran}$}

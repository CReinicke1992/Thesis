...
\begin{figure}
	...
	\end{subfigure}
	\caption{Pseudo-deblended data, $\mathbf{P}_{ps}$, sorted in common-shot gathers (a,b) and in a common-receiver gather (c). The pseudo-deblended data in (a) and the the pseudo-deblended data in (b,c) were shifted by different time delays. The overlapping sources map in the pseudo-deblended shot gathers as coherent events, while they map as incoherent spikes in the pseudo-deblended receiver gather.}
